const rollSlider = document.querySelector('#roll');
      ...
      function updateOrientation() {
        const roll = degreesToRadians(parseFloat(rollSlider.value));
        const pitch = degreesToRadians(parseFloat(pitchSlider.value));
        const yaw = degreesToRadians(parseFloat(yawSlider.value));
